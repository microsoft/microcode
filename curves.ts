...
namespace kojac.curves {
    ...
    export function easeIn(easeInFn: (t: number) => number): (a: number, b: number, t: number) => number {
        return (a, b, t) => util.lerp(a, b, easeInFn(t));
    }
    export function easeOut(easeInFn: (t: number) => number): (a: number, b: number, t: number) => number {
        return (a, b, t) => util.lerp(a, b, util.flip(easeInFn(util.flip(t))));
    }
    export function easeInOut(easeInFn: (t: number) => number): (a: number, b: number, t: number) => number {
        return (a, b, t) => util.lerp(a, b, util.lerp(easeInFn(t), util.flip(easeInFn(util.flip(t))), t));
    }
}