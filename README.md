...
Microsoft MicroCode is a tile-based programming language and editor for young learners, introducing the [BBC micro:bit V2](https://microbit.org). MicroCode runs in the browser or directly on hardware with [Arcade-compatible devices](https://arcade.makecode.com/hardware/).
