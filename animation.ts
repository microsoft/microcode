namespace microcode {
    ...
    export class EaseFrame {
        ...
        public init(currValue: number | Vec2) {
            if ((this.opts.endValue as any).x !== undefined) {
                ...
                if (currValue !== undefined && this.opts.relative) {
                    ...
                    this.state.endValue = Vec2.AddToRef(
                        currValue,
                        endValue,
                        new Vec2()
                    )
        ...
        public step(pctTime?: number) {
            ...
            if ((this.opts.endValue as any).x !== undefined) {
                ...
                // number
                this.state.currValue = this.opts.curve(
                    this.state.startValue as number,
                    this.state.endValue as number,
                    pctTime
                )
            }
        }
    ...
    export class Animation {
        ...
        constructor(
            private callback: (value: number | Vec2, tag?: string) => void,
            opts?: {
                loop?: boolean
                done?: () => void
            }
        ...
        private currFrame(): EaseFrame {
            return this.frameIdx < this.frames.length
                ? this.frames[this.frameIdx]
                : undefined
        }
